...
class Pct(nn.Module):
    def __init__(self, drop_rate, output_channels=40):
        ...
        self.dp2 = nn.Dropout(p=self.drop)
...
class SA_Layer(nn.Module):
    ...
    def forward(self, x):
        ...
        x = x + x_r
        return x
def pctModel(drop_rate,output_channels=40):
    mdoel = Pct(drop_rate,output_channels)
    return mdoel
