...
def train(args, io):
    ...
    if args.model == 'dgcnn':
        ...
        point_model = PointTransformer(drop_path_rate=0.1).to(device)
        point_model.fc = nn.Identity()
    ...
    # print(state_dict['student'])
    missing_keys, unexpected_keys = point_model.load_state_dict(new_student_dict, strict=False)  # 缺失的关键字,多余的关键字
    print(missing_keys)
    ...
    test_val_loader = DataLoader(ModelNet40SVM(partition='test', num_points=1024), batch_size=32)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--pretrained', default='../exp/KDCL_mn40_L8_outdim1024_e0.9998_b16_epo200_pt_optadamw_lr0.00005_teaTemp0.07_CosLR_v01/checkpoint0195.pth', type=Path, metavar='FILE',
